	 ...
	 <div class="navbar-static-topic" id="top">
							<div class="container">
								...
								<div class="collapse navbar-collapse navHeaderCollapse">
									...
									<li class="navigation"><a><p>Search <span class="glyphicon glyphicon-search"></span></p></a></l1>
	...
	<!-- logged in user information -->
		...
		<div class="jumbotron">
        	<div class="container">
        		...
        		<p>The website where you can get all the weather information you want, for any city in the world. To get the best experience, please sign in.</p>
        	</div>
        </div>
				 <div class="container">
			  <div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="https://i.pinimg.com/originals/50/78/f4/5078f44d1857c9a97d2555674f72dd6d.jpg">
...
<h3><?php echo "Temperature " .$json->temp_c .".c".'<br/>';
